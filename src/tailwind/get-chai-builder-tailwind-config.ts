...
const getChaiBuilderTailwindConfigV4 = (content: string[]) => {
  return {
    darkMode: "class",
    content: [...content, "node_modules/@chaibuilder/sdk/dist/*.{js,cjs}"],
    theme: {
      extend: shadcnThemeV4(),
    },
    plugins: [tailwindAnimate, tailwindTypography, tailwindForms, tailwindAspectRatio],
  };
};

export { getChaiBuilderTailwindConfig, getChaiBuilderTailwindConfigV4, shadcnTheme, shadcnThemeV4 };
