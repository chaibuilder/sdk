...
import { Icon, registerChaiBlock, Styles } from "@chaibuilder/blocks";
...
const IconBlock = (
  ...
  const iStyles = {
    ...styles,
    className: cn(styles.className, "inline-block c-inline-block"),
  };
...
registerChaiBlock(IconBlock as React.FC<any>, {
  ...
  group: "basic",
  props: {
    styles: Styles({ default: "text-black w-6 h-6" }),
    icon: Icon({
      title: "Icon",
