export const prelinePlugin = ({ addVariant, e }: any) => {
  addVariant("hs-dropdown-open", [
    ...
    ({ modifySelectors, separator }) => {
      modifySelectors(({ className }) => {
        return `.hs-dropdown.open .hs-dropdown-toggle .${e(`hs-dropdown-open${separator}${className}`)}`;
      });
    },
    ({ modifySelectors, separator }) => {
      modifySelectors(({ className }) => {
  ...
  addVariant("hs-overlay-layout-open", [
    ({ modifySelectors, separator }) => {
      modifySelectors(({ className }) => {
        return `.hs-overlay-body-open.${e(`hs-overlay-layout-open${separator}${className}`)}`;
      });
    },
    ({ modifySelectors, separator }) => {
      modifySelectors(({ className }) => {
  ...
  addVariant("hs-carousel-disabled", [
    ({ modifySelectors, separator }) => {
      modifySelectors(({ className }) => {
        return `.disabled.${e(`hs-carousel${separator}disabled${separator}${className}`)}`;
      });
    },
    ({ modifySelectors, separator }) => {
      modifySelectors(({ className }) => {
  ...
  addVariant("hs-strong-password-accepted", [
    ({ modifySelectors, separator }) => {
      modifySelectors(({ className }) => {
        return `.accepted.${e(`hs-strong-password-accepted${separator}${className}`)}`;
      });
    },
    ({ modifySelectors, separator }) => {
      modifySelectors(({ className }) => {
  ...
  addVariant("hs-strong-password-active", [
    ({ modifySelectors, separator }) => {
      modifySelectors(({ className }) => {
        return `.active.${e(`hs-strong-password-active${separator}${className}`)}`;
      });
    },
  ]);
  ...
  addVariant("hs-apexcharts-tooltip-dark", [
    ({ modifySelectors, separator }) => {
      modifySelectors(({ className }) => {
        return `.dark.${e(`hs-apexcharts-tooltip-dark${separator}${className}`)}`;
      });
    },
  ]);
