...
<html lang="en" dir="__HTML_DIR__" class="scroll-smooth h-full overflow-y-auto">
  <head>
    ...
    <script src="https://cdn.tailwindcss.com/4.1.11"></script>
    <!-- In Tailwind v4, forms, typography, and aspect-ratio are available through PostCSS plugins, not CDN params -->
    <style>
