  ...
  return (
    <div className="flex items-center">
      <Switch
        ...
        className={`${darkMode ? "bg-violet-600" : "bg-violet-300"} relative mr-2 inline-flex h-[20px] w-[32px] shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75`}>
        <span
          aria-hidden="true"
