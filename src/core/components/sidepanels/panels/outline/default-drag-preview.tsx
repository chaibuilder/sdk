  ...
  return (
    <div>
      <Overlay isDragging={isDragging}>
        <div
          className="pointer-events-none absolute z-50 rounded-sm border border-border bg-gray-100/80 font-semibold text-blue-600 shadow-md dark:border-gray-700 dark:bg-gray-800"
          style={style}>
