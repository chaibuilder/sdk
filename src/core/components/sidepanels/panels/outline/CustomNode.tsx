...
import { useBuilderProp, useHiddenBlockIds, useHighlightBlockId } from "../../../../hooks";
  ...
  return (
    ...
    <div
      ...
      <div className={"flex w-full items-center justify-between pr-2"}>
        ...
        <div className="invisible flex items-center space-x-1 group-hover:visible">
          {outlineItems.map((outlineItem) => (
            <Tooltip>
              ...
              <TooltipContent>{outlineItem.tooltip}</TooltipContent>
            </Tooltip>
          ))}
        </div>
      </div>
